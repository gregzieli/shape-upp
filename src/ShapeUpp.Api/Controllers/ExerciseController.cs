...
namespace ShapeUpp.Api.Controllers
{
    ...
    public class ExerciseController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody] ExerciseDto exercise)
        {
            ...
            exerciseEntity.MuscleIds = exercise.Muscles.Select(x => new MuscleId { Id = x }).ToHashSet();
            exerciseEntity.EquipmentIds = exercise.Equipment.Select(x => new EquipmentId { Id = x }).ToHashSet();
